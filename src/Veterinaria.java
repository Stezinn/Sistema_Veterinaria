...
public class Veterinaria extends ConexaoBancodeDados {
    ...
    public void Salvar(Animal animal) {
        ...
        String query = "INSERT INTO animals ( nome, raca,) VALUES ( '" + animal.getNome() + "', '" + animal.getRaca() + ")";
        try {
    ...
    public void executaDelete(String consultaDeDelete) {
        try {
            ...
            System.out.println("Animals deletado com sucesso!");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void editarAnimals(int codigo, String novoNome) {
        ...
        try {
            System.out.println("Animals editado com sucesso! " + query);
            this.connection.createStatement().executeUpdate(query);
